...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	try {
		...
		if($user["type"] == "user"){
			header("location:View/afficheranimals.php");}
	} catch (Exception $e) {
...
<head>
	<meta charset="UTF-8">
	<link rel="icon" href="view/assets/images/assets1/img/logo-inverted.png.png">
	<title>Vitalogic: Log in</title>
