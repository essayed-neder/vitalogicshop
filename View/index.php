...
<html lang="en">
  <head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="assets1/img/logo-inverted.png" />
  </head>
  <body>
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.html"><img src="assets1/img/logo-inverted.png" alt="logo" /></a>
          <a class="navbar-brand brand-logo-mini" href="index.html"><img src="assets1/img/logo-inverted.png" alt="logo" /></a>
        </div>
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic3">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="dash/add.php">Add reclamation</a></li>
                  <li class="nav-item"> <a class="nav-link" href="dash/articles.php">Show reclamations</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic4">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="dash/addA.php">Add animal</a></li>
                  <li class="nav-item"> <a class="nav-link" href="dash/showA.php">Show animalos</a></li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic5">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="addA.php">Add</a></li>
                  <li class="nav-item"> <a class="nav-link" href="showA.php">Show </a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item documentation-link">
              <a class="nav-link" href="afficheranimals.php" target="_blank">
                <span class="icon-bg">
