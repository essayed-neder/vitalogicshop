          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="addE.php">Add Event</a></li>
                <li class="nav-item"> <a class="nav-link" href="Events.php">Show Events</a></li>
              </ul>
            </div>
          </li>
          <ul class="nav">
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic2">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="showM.php">Show Members</a></li>
                  <li class="nav-item"> <a class="nav-link" href="AddM.php">ADD Members</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic3">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="add.php">Add reclamation</a></li>
                  <li class="nav-item"> <a class="nav-link" href="articles.php">Show reclamations</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic5">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="show.php">Show Products</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic6">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="showC.php">Show Panier</a></li>
